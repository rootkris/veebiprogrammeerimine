<?php
	...
	if (isset($_POST["gender"]) && !empty($_POST["gender"])){ //kui on määratud ja pole tühi
			...
			$signupGenderError = " (Palun vali sobiv!)";
	}
	...
	*/
	...
	$signupDaySelectHTML .= '<option value="" selected disabled>Vali sünnikuupäev</option>' ."\n";
	for ($i = 1; $i < 32; $i ++){
		if($i == $signupBirthDay){
...
<body>
	...
	<form method="POST">
		...
		<label>Sugu</label>
		<br>
		<input type="radio" name="gender" value="1" <?php if ($gender == "1") {echo 'checked';} ?>><label>Mees</label><?php echo $signupGenderError ?></span> <!-- Kõik läbi POST'i on string!!! -->
		<input type="radio" name="gender" value="2" <?php if ($gender == "2") {echo 'checked';} ?>><label>Naine</label><?php echo $signupGenderError ?></span>
		<br><br>
